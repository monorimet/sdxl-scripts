    ...
    module @hip_matmul_kernel_128x2048_1280x2048_f16 attributes {hal.device.targets = [#rocm_target]} {

      hal.executable.source private @hip_matmul_exe_128x2048_1280x2048 attributes {
        objects = #hal.executable.objects<{
          #rocm_gfx942_target = [
            #hal.executable.object<{
              path = "../tensile/output_128x1280x2048/Cijk_Alik_Bljk_HSS_BH_Bias_AS_SAV_UserArgs_MT32xWtnU2SRJ074qkQ6v4wfrhiWlW1wonyPBt_w30NplSC4=.co"
            }>
          ]
        }>
      } {
        ...
        ^bb0(%device: !hal.device, %workload: index):
          ...
          %c1 = arith.constant 40 : index
          %c2 = arith.constant 1 : index
          hal.return %c0, %c1, %c2 : index, index, index
        }
      }  // hal.executable.source

      func.func private @hip_matmul_128x2048_1280x2048_f16(%arg0: tensor<128x2048xf16>, %arg1: tensor<1280x2048xf16>) -> tensor<128x1280xf16> {
        %fZero = arith.constant 0.0 : f32

        // Allocation D Buffer (should actually be signal but fuck it)
        %de = tensor.empty() : tensor<128x1280xf32>
        %d = linalg.fill ins (%fZero : f32) outs (%de : tensor<128x1280xf32>) -> tensor<128x1280xf32>

        %ce = tensor.empty() : tensor<128x1280xf32>
        %c = linalg.fill ins (%fZero : f32) outs (%ce : tensor<128x1280xf32>) -> tensor<128x1280xf32>

        // Constant related to work:
        %gemm = arith.constant 1 : i32
        %internal = arith.constant 524545 : i32
        %free0 = arith.constant 128 : i32
        %free1 = arith.constant 1280 : i32
        %free2 = arith.constant 1 : i32
        %free3 = arith.constant 2048 : i32

        // Stride constants:
        %d_stride_0 = arith.constant 128 : i32
        %d_stride_1 = arith.constant 163840 : i32
        %c_stride_0 = arith.constant 128 : i32
        %c_stride_1 = arith.constant 163840 : i32
        %b_stride_0 = arith.constant 2048 : i32
        %b_stride_1 = arith.constant 2621440 : i32
        %a_stride_0 = arith.constant 2048 : i32
        %a_stride_1 = arith.constant 262144 : i32
        ...
        %workgroup0 = arith.constant 1024 : index
        %workgroup1 = arith.constant 40 : index
        %workgroup2 = arith.constant 1 : index

        // Dispatch a basic `ret = lhs * rhs` kernel.
        %0:2 = flow.dispatch @hip_matmul_exe_128x2048_1280x2048::@Cijk_Alik_Bljk_HSS_BH_Bias_AS_SAV_UserArgs_MT32x32x128_MI16x16x1_SN_LDSB0_AFC1_AFEM1_AFEM1_ASEM1_CLR1_EPS0_GRVWA8_GRVWB8_IU1_K1_LBSPPA256_LBSPPB256_LBSPPM0_LPA16_LPB16_LPM0_LRVW8_LWPMn1_MIAV0_MIWT1_1_MO40_NTn1_NTA0_NTB0_NTD0_NEPBS0_NLCA1_NLCB1_ONLL1_PGR2_PLR1_PKA1_SIA3_SS1_SPO0_SRVW0_SSO0_SVW1_TLDS1_USFGROn1_VWA1_VWB1_WSGRA0_WSGRB0_WG32_8_1[%workgroup0, %workgroup1, %workgroup2](
          ...
          : (i32, i32, i32, i32, i32, i32, tensor<128x1280xf32>, tensor<128x1280xf32>, tensor<128x2048xf16>, tensor<1280x2048xf16>, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32) -> (%d, %c)
        %trunc = arith.truncf %0#0 : tensor<128x1280xf32> to tensor<128x1280xf16>
        %i0 = torch.constant.int 0
        %i1 = torch.constant.int 1
        %transposeEmpty = tensor.empty() : tensor<128x1280xf16>
        %transposed = linalg.transpose ins(%trunc : tensor<128x1280xf16>) outs(%transposeEmpty : tensor<128x1280xf16>) permutation = [0, 1]
        return %transposed : tensor<128x1280xf16>
      }
