    ...
    module @hip_matmul_kernel_2048x1280_1280x1280_f16 attributes {hal.device.targets = [#rocm_target]} {

      hal.executable.source private @hip_matmul_exe_2048x1280_1280x1280 attributes {
        objects = #hal.executable.objects<{
          #rocm_gfx942_target = [
            #hal.executable.object<{
              path = "../tensile/output_2048x1280x1280/Cijk_Alik_Bljk_HSS_BH_Bias_AS_SAV_UserArgs_MT128LGssD3D5uUpJpwMOz9bV1KUetBSFPuVbIJbtPQNALVk=.co"
            }>
          ]
        }>
      } {
      ...
      func.func private @hip_matmul_2048x1280_1280x1280_f16(%arg0: tensor<2048x1280xf16>, %arg1: tensor<1280x1280xf16>) -> tensor<2048x1280xf16> {
        ...
        %b_stride_1 = arith.constant 1638400 : i32
        ...
        %0:2 = flow.dispatch @hip_matmul_exe_2048x1280_1280x1280::@Cijk_Alik_Bljk_HSS_BH_Bias_AS_SAV_UserArgs_MT128x80x64_MI16x16x1_SN_LDSB1_AFC1_AFEM1_AFEM1_ASEM1_CLR1_EPS0_GRVWA8_GRVWB4_IU1_K1_LBSPPA256_LBSPPB128_LBSPPM0_LPA16_LPB16_LPM0_LRVW8_LWPMn1_MIAV0_MIWT2_5_MO40_NTn1_NTA0_NTB0_NTD0_NEPBS16_NLCA1_NLCB1_ONLL1_PGR2_PLR1_PKA1_SIA3_SS1_SPO0_SRVW0_SSO0_SVW2_TLDS1_USFGROn1_VWA2_VWB1_WSGRA0_WSGRB0_WG64_4_1[%workgroup0, %workgroup1, %workgroup2](
          ...
          : (i32, i32, i32, i32, i32, i32, tensor<2048x1280xf32>, tensor<2048x1280xf32>, tensor<2048x1280xf16>, tensor<1280x1280xf16>, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32, i32) -> (%d, %c)
